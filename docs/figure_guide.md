...
| 2 | CODEX cellular neighborhoods and neutrophil proximity to FAP/α5β1-associated fibroblasts | `analyses/source/spatial`, `analyses/source/figure_02` | `source_data/codex_high_yield`, `source_data/earlier_figure_sources/figure2` |
...
| 5 | ATN-161, tissue inflammation, neutrophil neighborhoods and downstream signaling | `analyses/source/mouse`, `analyses/source/figure_assembly` | `source_data/figure_05`, `source_data/earlier_figure_sources/figure5`, `source_data/mouse_comparison` |
| 6 | Biological-mouse comparisons of cell composition, epithelial RNA programs and reciprocal communication | `analyses/source/mouse`, `analyses/source/epithelial_and_validation` | `source_data/figure_06`, `source_data/epithelial_programs`, `source_data/mouse_comparison` |
...
| 10 | Stromal detection and neutrophil proteins after ATN-161 | Mouse flow analyses |
