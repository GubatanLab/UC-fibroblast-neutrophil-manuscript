...
for filename,n in [('Main_Figures_1_to_7.pdf',7),('Extended_Data_Figures_1_to_10.pdf',10)]:
...
print(json.dumps({'status':'passed' if not errors else 'failed','files_checked':len(rows),'errors':errors},indent=2))
